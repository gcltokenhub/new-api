...
export const STATIC_I18N_KEYS = [
  // Portal navigation and data-driven section copy.
  'portal.brand',
  'portal.skip',
  'portal.nav.label',
  'portal.nav.products',
  'portal.nav.models',
  'portal.nav.experience',
  'portal.nav.compute',
  'portal.nav.solutions',
  'portal.nav.docs',
  'portal.nav.console',
  'portal.action.console',
  'portal.action.connect',
  'portal.action.experience',
  'portal.action.explore',
  'portal.action.integration',
  'portal.action.try',
  ...
  'portal.benefit.api',
  'portal.benefit.usage',
  'portal.benefit.keys',
  'portal.architecture.title',
  'portal.architecture.gateway',
  'portal.architecture.models',
  'portal.architecture.models.title',
  'portal.architecture.models.description',
  'portal.architecture.apps',
  'portal.architecture.apps.title',
  'portal.architecture.apps.description',
  'portal.architecture.compute',
  'portal.architecture.compute.title',
  'portal.architecture.compute.description',
  'portal.compute.eyebrow',
  'portal.compute.title',
  'portal.compute.description',
  'portal.compute.api.label',
  'portal.compute.api.title',
  'portal.compute.api.description',
  'portal.compute.api.detail',
  'portal.compute.gpu.label',
  'portal.compute.gpu.title',
  'portal.compute.gpu.description',
  'portal.compute.gpu.detail',
  'portal.compute.gateway.label',
  'portal.compute.gateway.title',
  'portal.compute.gateway.description',
  'portal.compute.gateway.detail',
  'portal.supply.title',
  'portal.supply.connect',
  'portal.supply.connect.description',
  'portal.supply.keys',
  'portal.supply.keys.description',
  'portal.supply.usage',
  'portal.supply.usage.description',
  'portal.supply.logs',
  'portal.supply.logs.description',
  'portal.models.title',
  'portal.models.description',
  'portal.models.categories',
  'portal.models.popular',
  'portal.models.text',
  'portal.models.multimodal',
  'portal.models.deepseek',
  'portal.models.qwen',
  'portal.models.glm',
  ...
  'portal.services.eyebrow',
  'portal.services.title',
  'portal.services.description',
  'portal.services.usage',
  'portal.services.usage.description',
  'portal.services.quota',
  'portal.services.quota.description',
  'portal.services.routing',
  'portal.services.routing.description',
  'portal.services.logs',
  'portal.services.logs.description',
  'portal.services.deployment',
  'portal.services.deployment.description',
  'portal.services.access',
  'portal.services.access.description',
  'portal.docs.eyebrow',
  'portal.docs.title',
